...
const EmployeProfile = () => {
  ...
  return (
    <div>
            ...
            <div className="mb-6">
              ...
              <form onSubmit={handleUpload} className="flex flex-col items-center gap-3">
                ...
                <button
                  ...
                  className={`w-40 py-2 rounded-full text-white font-semibold shadow-md ${isLoading || !selectedFile
      ...
      <div
        onClick={() => Logout()}
        className='border bg-red-500 px-10 py-5 w-fit rounded-md cursor-pointer'>
