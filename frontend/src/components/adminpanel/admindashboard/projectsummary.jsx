            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">5 members</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">Mobile App</div>
                    <div className="text-sm text-gray-500">Mobile Development</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">3 members</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">Dashboard System</div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">4 members</td>
                </tr>
              </tbody>
            </table>
          </div>
