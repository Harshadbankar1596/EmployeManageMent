...
// const StatsSummary = ({ employees }) => {
//   // Use the isToday function to accurately count present employees
...
const EmployeeCard = ({ emp, idx, handleSort, getSortIcon, loadingEmployees, loadingSetAdmin, adminid, setadminid, setopenadminmodal, setopencancelmodal }) => {
  const isPresent = isToday(emp?.log?.date);
          ...
          <div className="flex items-center gap-2">
            ...
            {(loadingEmployees || (loadingSetAdmin && adminid === emp.userid)) ? 
              ...
              emp?.isadmin === "admin" ? 
                ...
                /> : 
                <PiShieldPlus 
                  onClick={() => { setadminid(emp.userid); setopenadminmodal(true); }} 
                  className='text-xl cursor-pointer' 
                  title='Employee' 
                />
            }
...
const EmployeesTable = ({ sortedEmployees, handleSort, getSortIcon, loadingEmployees, loadingSetAdmin, adminid, setadminid, setopenadminmodal, setopencancelmodal }) => {
  return (
            ...
            {sortedEmployees.length > 0 ? (
              sortedEmployees.map((emp, idx) => (
                <EmployeeCard 
                  ...
                  loadingSetAdmin={loadingSetAdmin}
                  adminid={adminid}
