...
const side = () => {
  ...
  return (
    <div className="hidden lg:block h-full">
      <div className="bg-blue-950 h-full text-white shadow-lg transition-all duration-300 fixed lg:static z-30 flex flex-col">
        {/* Logo Section */}
        ...
        {/* Navigation */}
        <nav className="flex-1 px-2 lg:px-4 py-6 lg:py-8 mt-6 lg:mt-10">
          <ul className="space-y-3 lg:space-y-4">
            <li>
              <Link 
                to={"/"} 
                className="flex items-center gap-2 lg:gap-3 px-3 lg:px-4 py-2 lg:py-3 rounded-lg hover:bg-blue-800 transition-colors duration-200 text-sm lg:text-base font-medium"
              >
